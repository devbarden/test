...
//   a schema for its input, and one call into the service. Logic here would
//   be logic the tests of the service do not cover.
//
...
export const listApplications = createServerFn({ method: 'GET' })
	...
	.inputValidator(listApplicationsSchema)
...
export const getApplication = createServerFn({ method: 'GET' })
	.middleware([userScopeMiddleware])
	.inputValidator(applicationIdSchema)
	.handler(({ context, data }) =>
