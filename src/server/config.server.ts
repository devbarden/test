...
export function createAppConfig(env: NodeJS.ProcessEnv = process.env) {
	...
	return {
		...
		generation: {
			...
			// ═════════════════════════════════════════════════════════════════
			//   Headroom over the 150–230 words asked for: non-Latin scripts
			//   tokenise two to three times denser than English, and a letter
			//   cut by this limit ends in the same [DONE] as a finished one.
			// ═════════════════════════════════════════════════════════════════
			maxTokens: 1200,
		},
