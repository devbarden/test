...
import { accountModule } from '@/server/modules/account/account.module.server'
import { applicationsModule } from '@/server/modules/applications/applications.module.server'
import { billingModule } from '@/server/modules/billing/billing.module.server'
import { generationModule } from '@/server/modules/generation/generation.module.server'
