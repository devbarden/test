...
type UpstreamErrorOptions = AppErrorOptions & { transient?: boolean }

// ═══════════════════════════════════════════════════════════════════════════
//   `transient` marks a failure the next attempt may not repeat (a dropped
//   connection, a 5xx); a refused token or a rate limit is not one.
// ═══════════════════════════════════════════════════════════════════════════
export class UpstreamError extends AppError {
	...
	constructor(
		...
		message: string,
		{ transient = false, ...options }: UpstreamErrorOptions = {},
	) {
