...
import type { GenerateCommand } from '@/domain/generation/generation.schema'
import {
...
import { requestLetter } from '../api/generation-client'
import { LetterGenerationFailure } from '../api/letter-generation-failure'
