...
import {
	...
	refreshApplications,
	replaceApplication,
} from '@/client/features/applications/api/application.cache'
import { refreshUsage } from '@/client/features/billing/api/billing.cache'
import { usePlanLimits } from '@/client/features/billing/hooks/use-plan-limits'
import { type GenerationResult, useLetterGeneration } from '@/client/features/generation/hooks/use-letter-generation'
import { redirectToSignIn } from '@/client/lib/query/query-client'
...
// ═══════════════════════════════════════════════════════════════════════════
export function useGenerateApplication(saved: ApplicationDto | undefined, { onStart }: Options = {}) {
	...
	const generate = async (input: ApplicationInput): Promise<ApplicationDto | undefined> => {
